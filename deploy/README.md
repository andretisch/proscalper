...
(скан ~5–10 с, пауза по `CYCLE_INTERVAL_SEC`, по умолчанию 30 с). Узкое место
не память, а диск — см. «Диск» ниже.
...
(`ORDERBOOK_SNAPSHOT_INTERVAL_SEC=15`) пишет в базу чаще торгового скана
(`CYCLE_INTERVAL_SEC=30`): при пяти символах perp + spot это **~40–45 МБ в сутки**.
